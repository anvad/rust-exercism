...
fn get_score(hand: &str) -> u32 {
    ...
    match hand_nums[..] {
        ...
        [n1, n2, n3, n4, l1] if n1 == n4 => FOUR_OAK + sum((l1, n1, n2, n3, n4)),
        [l1, n1, n2, n3, n4] if n1 == n4 => FOUR_OAK + sum((l1, n1, n2, n3, n4)),
        [p1, p2, t1, t2, t3] if t1 == t3 && p1 == p2 => FULL_HOUSE + sum((p1, p2, t1, t2, t3)),
        [t1, t2, t3, p1, p2] if t1 == t3 && p1 == p2 => FULL_HOUSE + sum((p1, p2, t1, t2, t3)),
        [n1, n2, n3, l1, l2] if n1 == n3 => THREE_OAK + sum((l1, l2, n1, n2, n3)),
        [l1, n1, n2, n3, l2] if n1 == n3 => THREE_OAK + sum((l1, l2, n1, n2, n3)),
        [l1, l2, n1, n2, n3] if n1 == n3 => THREE_OAK + sum((l1, l2, n1, n2, n3)),
    ...
    // Note: for Four-of-a-kind, three-of-a-kind and full-house, we only need to test the
    //  first item with the last item since the tuple of cards is already sorted by card number
}
